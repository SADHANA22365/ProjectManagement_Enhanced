        ...
        <main style={{ flex: 1, padding: "2rem", maxWidth: 700, width: "100%" }}>
          ...
          <div className="card animate-fade-up" style={{ padding: "1.75rem", marginBottom: "1.5rem", animationDelay: "0.05s" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }}>
              ...
              <div>
                ...
                <span style={{ display: "inline-block", marginTop: "0.375rem", fontSize: "0.7rem", fontWeight: 700, background: "var(--accent-soft)", color: "var(--accent)", borderRadius: 999, padding: "0.15rem 0.625rem", letterSpacing: "0.06em", textTransform: "uppercase" }}>
                  User
                </span>
              </div>
            </div>
          ...
          <div className="card animate-fade-up" style={{ padding: "1.75rem", animationDelay: "0.1s" }}>
            ...
            <form action={updateUserProfile} style={{ display: "flex", flexDirection: "column", gap: "1.125rem" }}>
              <input type="hidden" name="redirect_to" value="/client/profile" />
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                ...
                <div>
                  <label style={{ display: "block", fontSize: "0.75rem", fontWeight: 700, color: "var(--muted)", marginBottom: "0.375rem", textTransform: "uppercase", letterSpacing: "0.06em" }}>Email</label>
              ...
              <div>
                ...
                <textarea name="bio" rows={3} placeholder="Tell us about yourself..." className="input" style={{ resize: "vertical" }} />
              </div>
